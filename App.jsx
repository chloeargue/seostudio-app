...
export default function App() {
  ...
  const generateContent = async () => {
    ...
    const prompts = {
      article: `Tu es un expert SEO français. Nous sommes en 2026. Client: ${client.name}, secteur: ${client.sector}, ville: ${client.location}, audience: ${client.audience||"clients locaux"}. ${sc} Mot-clé cible: "${genKw}".

Génère un article de blog SEO prêt à publier. RÈGLES STRICTES:
- N'écris JAMAIS **, *, ---, ## ou tout signe markdown
- N'écris JAMAIS l'année 2024, utilise uniquement 2026 ou des formulations intemporelles
- Respecte EXACTEMENT ce format:

TITRE H1: [titre accrocheur optimisé pour le mot-clé]

META TITLE: [60 caractères max]

META DESCRIPTION: [155 caractères max avec appel à l'action]

INTRODUCTION: [2 phrases percutantes qui accrochent le lecteur]

H2: [Premier sous-titre]
[Paragraphe de 80 mots minimum sur ce sujet]
...
CONCLUSION: [1 paragraphe avec appel à l'action clair]

MOTS-CLÉS SECONDAIRES: [5 mots-clés séparés par des virgules]

BALISES HN: [liste des H2 et H3 suggérés pour structurer la page]`,
