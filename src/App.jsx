...
JSON: {"h1_optimise":"nouveau H1 max 70 car","h2_suggestions":["H2 1","H2 2","H2 3"],"intro_optimisee":"intro 80 mots commence par mot-clé","recommandations":["reco 1","reco 2","reco 3"]}`;
      ...
      // 4. Mettre à jour métas via le plugin SEO Studio Connector
      const updateRes = await fetch(`${base}/wp-json/wp/v2/pages/${page.id}`, {
        method: 'POST',
        headers: {
      ...
      if (!updateRes.ok) {
        const errMsg = updateData?.message || "Mise à jour échouée";
