                  ...
                  <div style={{ background:"#fff", borderRadius:12, border:"1px solid #e5e7eb", overflow:"hidden" }}>
                    ...
                    {wpPages.map(page => (
                      <div key={page.id} style={{ display:"flex", alignItems:"center", gap:8, padding:"12px 16px", borderBottom:"1px solid #f3f4f6" }}>
                        ...
                        <button onClick={() => optimizePage(page)} disabled={wpOptimizing === page.id} style={{ fontSize:11, color:"#fff", background:wpOptimizing===page.id?"#9FE1CB":"#16a34a", border:"none", borderRadius:6, padding:"6px 12px", cursor:"pointer", fontWeight:600, whiteSpace:"nowrap", flexShrink:0 }}>
                          {wpOptimizing === page.id ? "⏳ En cours..." : "✨ Optimiser métas"}
                        </button>
                      </div>
                    ))}
                  </div>
