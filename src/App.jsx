...
IMAGES PEXELS: [3 requêtes en anglais]`,
    ...
    try { let r = await callMistral(prompts[genType], genKw, client.sector, client.location); r = r.replace(/\*\*/g, '').replace(/\*/g, '').replace(/---/g, '').replace(/^#{1,4} /gm, ''); setGenResult(r); } catch { setGenResult("❌ Erreur de génération."); } finally { setGenerating(false); }
  };
