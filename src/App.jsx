...
export default function App() {
  ...
  const generateContent = async () => {
    ...
    const prompts = {
      article: `Tu es un expert SEO français. Client: ${client.name} (${client.sector}, ${client.location}). Audience: ${client.audience||"clients locaux"}. ${sc} Mot-clé cible: "${genKw}". Génère un article de blog SEO complet. IMPORTANT: N'utilise JAMAIS de **, *, --- ou markdown. Texte brut uniquement. Structure:\nTITRE H1: [titre optimisé]\nMETA TITLE: [60 car max]\nMETA DESCRIPTION: [155 car max]\nINTRODUCTION: [2 phrases percutantes]\nH2 PRINCIPAL: [titre section]\n[80 mots de contenu]\nH2 SECONDAIRE: [titre section]\n[80 mots de contenu]\nCONCLUSION: [CTA clair]\nMOTS-CLÉS SECONDAIRES: [liste 5]\nBALISES HN SUGGÉRÉES: [liste H2/H3]`,
