...
IMAGES PEXELS: [3 requêtes en anglais]`,
    ...
    try { const r = await callMistral(prompts[genType], genKw, client.sector, client.location); setGenResult(r); } catch { setGenResult("❌ Erreur de génération."); } finally { setGenerating(false); }
  };
