...
Client: ${client.name} | Secteur: ${client.sector} | Ville: ${client.location} | ${sc}
Mot-clé principal: "${blogKw}"
Mots-clés GSC du site: ${topKw || client.sector}

Rédige un article de blog SEO complet et prêt à publier sur WordPress.
RÈGLES ABSOLUES:
- N'utilise JAMAIS **, *, #, ---, markdown
- N'écris JAMAIS d'année spécifique
- Phrases courtes pour faciliter la lecture
- Entre 800 et 1200 mots

Génère UNIQUEMENT ce JSON valide sans backticks:
{
  "titre": "titre H1 accrocheur max 70 car avec mot-clé",
  "slug": "slug-url-optimise",
  "meta_title": "meta title 60 car max",
  "meta_description": "meta description 155 car max avec CTA",
  "extrait": "résumé de 30 mots pour l'extrait WordPress",
  "contenu_html": "<h2>Premier sous-titre</h2><p>Contenu...</p><h2>Deuxième sous-titre</h2><p>Contenu...</p><h2>Questions fréquentes</h2><h3>Question 1 ?</h3><p>Réponse...</p><h3>Question 2 ?</h3><p>Réponse...</p><p><strong>Conclusion avec CTA pour contacter ${client.name}</strong></p>"
}`;
