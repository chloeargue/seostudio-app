...
export default function App() {
  ...
  const logout = () => { if(user) localStorage.removeItem('seostudio_client_' + user.id); setUser(null); setClient(null); setGenResult(null); setAuditResult(null); setTracking([]); setSeasons([]); };
